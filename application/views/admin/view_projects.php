                            ...
                            <table class="table table-bordered table-hover">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td><?php 
                                        $this->db->where('category_id',$project['category_id']);
                                        ...
                                        <td><?php echo date('m/d/Y ',$project['upload_date']);; ?></td>
                                        <td><?php echo $project['uploader']; ?></td>
                                        <td><a href="<?php 
                                        $project_name = preg_replace('#[ -]+#', '-',$project['project_name']);
                                        echo SITEURL.'user/project_description/'.$project_name.'/'.$project['upload_date'].'/'.$project['project_id'];?>" class="btn btn-primary"> <i class=" fa fa-eye"></i></a></td>
                                    </tr>
