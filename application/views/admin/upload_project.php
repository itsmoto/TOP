...
<body>
    ...
    <div id="wrapper">
                ...
                <ul class="nav navbar-nav side-nav">
                  ...
                  <li>
                        ...
                        <ul id="demo_n" class="collapse">
                            ...
                            <li>
                                <a href="<?php echo SITEURL.'user/view_news';?>">View News</a>
                            </li>
        ...
        <div id="page-wrapper">
            ...
            ?>
                        <form role="form" action="<?php echo SITEURL.'user/upload_project';?>" method="POST" enctype="multipart/form-data">

                            <div class="form-group">
                                <label>Project Name:</label>
                                <input class="form-control" name="project_name" placeholder="Project Name"  value="<?php echo set_value('project_name'); ?>">
                                <p class="help-block">Example: Shopping Information System.</p>
                            </div>
                            <div class="form-group">
                                <label>Payment:</label>
                            ...
                            <div class="form-group">
                                ...
                                <p class="help-block">Example: Shopping.zip.</p>
                            </div>
                            <div class="form-group">
                                <label>Description:</label>
                                <textarea class="form-control" rows="4" name="description"><?php echo set_value('description'); ?></textarea>
                                <p class="help-block">Provides the abstract of the system </p>
                            </div>
